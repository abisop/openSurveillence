...
path_to_model = "weight-04-0.77.h5"
video_path = "D:/murdering/uccrime_Shooting003_x264.mp4"
save = False
thresh = 0.5
# Load LRCN_model
...
while video_reader.isOpened():
    ...
    if len(frames_queue) == SEQUENCE_LENGTH:
        ...
        predicted_labels_probabilities = saved_model.predict(
            np.expand_dims(frames_queue, axis=0),verbose = False)[0]
        ...
        print(predicted_labels_probabilities[3])
    # Write Video
    if save:
        out_vid.write(frame)
